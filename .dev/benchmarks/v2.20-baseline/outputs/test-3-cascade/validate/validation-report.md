...
warnings_count: 0
failed_agents: adversarial-merge
passed_agents: reflect-opus-architect, reflect-haiku-analyst
---

> **WARNING: DEGRADED VALIDATION REPORT**
>
> The following validation agent(s) FAILED: **adversarial-merge**
>
...
- **Failed agents:** adversarial-merge
- **Passed agents:** reflect-opus-architect, reflect-haiku-analyst
