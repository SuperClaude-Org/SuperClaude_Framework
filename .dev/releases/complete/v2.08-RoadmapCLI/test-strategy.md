...
| M2 | SprintConfig inherits PipelineConfig; release_dir property works; ClaudeProcess re-exported; sprint tests pass | All D2.1-D2.4 ACs met; `uv run pytest tests/sprint/` exits 0 (AC-06); no sprint test modifications during migration |
